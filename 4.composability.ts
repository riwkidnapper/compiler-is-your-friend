...
like the Composable implementation?
    การยุบรวบของโค้ดที่ซ้ำซ้อนเพื่อที่จะทำให้โค้ดมีความcleanเมื่อมีการเขียนโค้ดที่ซ้ำซ้อนกันควรจะมีการComposable เพื่อที่จะได้เรียกใช้เพียงครั้งเดียวเมื่อต้องการ
